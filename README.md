...
- **FLUX 3 Video** (BFL on fal) — T2V · I2V · first→last · **extend**. 5–20s (or auto) · 720p/1080p · optional native audio. Est. ~$0.17/s @720p · ~$0.29/s @1080p. Studio Video: I2V / First→Last / Extend (V2V). **Director**: Continuous I2V + First→Last (not multi_prompt cuts; Kling stays multi-shot).
